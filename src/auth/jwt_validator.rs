...
impl JwtValidator {
    ...
    pub fn validate_token(&self, token: &str) -> Result<Claims, jsonwebtoken::errors::Error> {
        ...
        println!("Expected audience: {:?}", validation.aud);
    ...
    pub fn has_required_scope(&self, scopes: &[String], method_name: &str) -> bool {
        let required_scope = if method_name.contains("CreateAccount") || method_name.contains("DeleteAccount") {
            "account:write"
        } else if method_name.contains("GetAccountDetails") || method_name.contains("GetAccountDetailsByUserId") {
            "account:read"
        } else if method_name.contains("CreditAccount") || method_name.contains("DebitAccount") {
            "account:transaction"
        } else if method_name.contains("FreezeAction") {
            "account:admin"
        } else {
            return false;
        };
